...
const socials = [
  { href: "https://t.me/mirzohidsalimov", icon: telegram, label: "Telegram" },
  { href: "https://github.com/Mirzohid22", icon: github, label: "GitHub" },
  {
  ...
  return (
    <div className="flex items-center gap-4">
      {socials.map((s) => (
        ...
        >
          <Image src={s.icon} width={22} height={22} alt={s.label} />
        </Link>
      ))}
      <Link
        href="https://leetcode.com/u/MirzohidSalimov/"
        target="_blank"
        aria-label="LeetCode"
        className="opacity-50 hover:opacity-100 transition-opacity duration-200"
      >
